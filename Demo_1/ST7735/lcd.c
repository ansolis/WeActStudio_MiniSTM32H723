...
ST7735_IO_t st7735_pIO = {
    lcd_init,     // Init function
    NULL,         // DeInit function
    0,            // Address
    lcd_writereg, // Write register function
    lcd_readreg,  // Read register function
    lcd_senddata, // Send data function
    lcd_recvdata, // Receive data function
    lcd_gettick   // Get tick function
};
